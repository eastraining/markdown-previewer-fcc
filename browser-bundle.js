...
/***/ function(module, exports, __webpack_require__) {
	...
	// initialText
	var initialText = '# This is markdown.\
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      var output = this.updateText();
	      return React.createElement(
	        'div',
	        { className: 'row site-content' },
	        React.createElement(TextInput, { value: this.state.value, onChange: function onChange(event) {
	            return _this2.handleChange(event);
	          } }),
	        React.createElement(TextOutput, { output: output })
	      );
	    }
	  }]);
	...
	function TextInput(props) {
	  return React.createElement(
	    ...
	    React.createElement(
	      'form',
	      null,
	      React.createElement('textarea', { value: props.value, onChange: function onChange(event) {
	...
	function TextOutput(props) {
	  return React.createElement(
	    'div',
	    { className: 'col-xs-6' },
	    React.createElement('div', { dangerouslySetInnerHTML: props.output })
	  );
	}
